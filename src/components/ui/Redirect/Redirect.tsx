...
import { REDIRECT_CONFIGS, RedirectConfig } from "./redirectConfig";
...
const Redirect = () => {
  ...
  return (
    <div
      className={`fixed inset-0 bg-background/50 backdrop-blur-[1px] flex items-center justify-center z-[51] transition-opacity duration-500 ${
        isVisible
